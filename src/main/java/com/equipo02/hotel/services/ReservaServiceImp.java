...
public class ReservaServiceImp implements ReservaService {
	 ...
	 * 
	 * @param Objeto del tipo Long que es el id de la Reserva.
	 * @return Lista de entidades de tipo Reserva.
	 * @throws EntityNotFoundException si la Reserva con el id asignado no es
	 * encontrado en la persistencia.
	 */
	@Override
	@Transactional(readOnly = true)
	 ...
	 *
	 * @param Objeto del tipo Reserva que se va a persistir.
	 * @return El objeto luego de persistirlo
	 * @throws IllegalOperationException si el id de la Reserva es inválido o 
	 ...
	 * @throws EntityNotFoundException si la Reserva con el id asignado no es
	 * encontrado en la persistencia.
	 * @throws IllegalOperationException si el id de la Reserca es inválido o 
	 * ya existe en la persistencia.
	 *                                   
	 */	
	@Override
